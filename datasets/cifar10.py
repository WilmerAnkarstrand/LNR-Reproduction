...
class CIFAR10_LT(object):
    ...
    def __init__(self, distributed, root='./data/cifar10', imb_type='exp',
        ...
        val_dataset = IMBALANCECIFAR10(root=root, imb_type=imb_type, imb_factor=imb_factor, rand_number=1223, train=False, download=True, transform=eval_transform, size=config.valsize_factor)
